...
#ifndef __omnirig_interface_h__
#define __omnirig_interface_h__
...
EXTERN_C __declspec(selectany) const IID IID_IOmniRigX = {0x501A2858,0x3331,0x467A,{0x83,0x7A,0x98,0x9F,0xDE,0xDA,0xCC,0x7D}};
...
EXTERN_C __declspec(selectany) const IID IID_IRigX = {0xD30A7E51,0x5862,0x45B7,{0xBF,0xFA,0x64,0x15,0x91,0x7D,0xA0,0xCF}};
...
EXTERN_C __declspec(selectany) const IID IID_IPortBits = {0x3DEE2CC8,0x1EA3,0x46E7,{0xB8,0xB4,0x3E,0x73,0x21,0xF2,0x44,0x6A}};
